...
if(isset($_SESSION['CurrentUser']))
{
	...
	echo "<div class=container><form action=change_pass.php  method=post>
		New Password<input type='password' name='newpass' class=field required><br>
		Confirm Password <input type='password' name='confirmpass' class=field required><br>	
